  ...
  async render() {
    return `
      ...
      <div class="page" style="display: flex; flex-direction: column; gap: 20px; padding: 0 20px;">
          ...
          <div style="overflow-x: auto; border-radius: 15px; border: 1px solid #eef2ed;">
            <table style="width: 100%; border-collapse: collapse; font-size: 0.8rem;">
              <thead style="background: #6CA651; color: #ffffff;">
                <tr>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">TANGGAL & JAM</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">HEWAN</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">DERET</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">SESI</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">KESEHATAN</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">KELAYAKAN</th>
                  <th style="padding: 15px; text-align: left; border-bottom: 2px solid #5a8d43;">PETUGAS</th>
                  <th style="padding: 15px; text-align: center; border-bottom: 2px solid #5a8d43;">AKSI</th>
                </tr>
              </thead>
              <tbody id="reportTableBody">
                <tr><td colspan="8" style="padding: 30px; color: #ccc; text-align: center;">Belum ada laporan masuk.</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div id="taskModal" class="modal-overlay"><div class="modal-box checklist-modal"><button class="close-modal-btn">&times;</button><h3 style="font-size:1.1rem; display:flex; align-items:center; gap:10px; margin-bottom: 20px; color: #1f3326; padding: 25px 25px 0;"><span style="background:#eef2ed; padding:6px; border-radius:8px;">✅</span> Detail Pekerjaan</h3><div id="taskListContent" style="display:flex; flex-direction:column; gap:0; padding: 0 25px 25px;"></div></div></div>
      </div>
      ...
      <style>
        ...
        .health-entry-card { background: white; padding: 20px; border-radius: 16px; border: 1px solid #feb2b2; position: relative; display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 10px; }
        .grid-full { grid-column: span 2; }
        .btn-remove-entry { position: absolute; top: -10px; right: -10px; background: #c53030; color: white; border: none; border-radius: 50%; width: 28px; height: 28px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 0.8rem; }
